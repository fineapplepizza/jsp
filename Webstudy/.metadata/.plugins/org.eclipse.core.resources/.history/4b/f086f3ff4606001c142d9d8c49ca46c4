...
*우량주: 타 기업에 비해 수익성,안전성,성장성 등이 좋은 기업');
...
');
insert into StockTerms values('거래량','하루 동안 사고 팔린 주식의 양을 말해요.');
insert into StockTerms values('호가','주식 거래를 위해 가격을 제시하는 것을 말해요. 즉 내가 팔거나 사고 싶은 가격에 주문을 넣어두는 것이에요.');
...
하한가: 하루 중 주가 하락폭이 30%인 가격을 말해요.');
insert into StockTerms values('예수금','주식 거래를 위해 증권 계좌에 입금한 투자 금액을 말해요.');
...
매수의 경우도 같아요.
700원으로 매수예약을 넣어 높아도 주가가 200원대로 내려가지 않는 이상 미체결로 남게 되요.');
...
*배당: 기업이 일정기간 영업활동으로 벌어들인 이익금 일부 또는 전부를 주주가 가져가는 것');
insert into StockTerms values('시가총액','그 기업 시장에서 얼마만큼의 가치를 인정받고 있는지를 말해요.
(시가총액 = 전체 주식 수 x 주가)');
insert into StockTerms values('증거금','주식을 사기 위한 매수주문 시점에 약정대금(체결된 수량에 가격을 곱한 금액)의 일정 비율(증거금률)의 금액이 먼저 인출되는데요. 이를 증거금이라고 해요. 일종의 거래 보증금이라고 할 수 있어요. 증권 계좌를 개설할 때 증거금을 설정할 수 있는데요, 보통은 증거금률이 40%로 적용되어 있어요. 증거금률이 40%라는 이야기는 100만원어치 주식을 살 때 40만 원만 가지고 있으면 거래가 성사된다는 뜻이에요. 나머지 60만원은 이틀 후에 입금하면 되죠. 만약 주식을 이제 막 시작했다면 증거금률을 100%로 설정해두는 게 좋아요.');
...
*당기순이익:기업이 일정기간동한 얻은 모든 수익에서 지출한 모든 비용을 공제하고 순수하게 남은 이익');
...
예를 들어 자본총액이 1억원인 회사가 천만원 이익을 냈다면 ROE는 10%가 되요 ');
...
예를 들어 1주당 수익이 1,000원이고 현재 주가가 18,000원이라면‘ 현재 주가/1주당 순이익’공식을 대입하여 “18,000원/1000원”로 PER은 18배가 돼요. 즉 PER은 낮을수록 좋지만 경쟁사와 비교해야 해요.');
...
수치가 낮으면 낮을수록 자산가치가 저평가되어 있다고 보면되요. 낮으면 낮을수록 좋다는 얘기에요.');
...
');
insert into StockTerms values('이동평균선','매일 종가를 기준으로 이동평균치를 차트에 표시한 연장선으로 일정 기간의 주가 평균가격을 그어놓은 선이에요. 단기(5,20일),중기(60일), 장기(120,240일) 이동평균선으로 구분해요.');
insert into StockTerms values('추세선','가가 움직이는 방향을 이은 가상의 선 이에요. 즉 주가에는 일정한 흐름이 있고, 흐름을 추세라고 하고, 이것을 선으로 표시한 것을 추세선이라고 말해요');
insert into StockTerms values('테마주','정치적 사회적 이슈나 산업 트렌드를 따라가는 주식 종목들이에요.');
