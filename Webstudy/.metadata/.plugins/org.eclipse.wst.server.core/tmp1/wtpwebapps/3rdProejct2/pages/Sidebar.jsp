      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li class="nav-item dropdown">
                <a href="StockInfo.jsp" class="nav-link"> <span>주가정보</span></a>
                <a href="Predict.jsp" class="nav-link"> <span>주가예측</span></a>
              </li>
              ...
              <li class="nav-item dropdown">
                <a href="Mypage.jsp" class="nav-link"> <span>회원정보수정</span></a>
              </li>
            </ul>

            <div class="mt-4 mb-4 p-3 hide-sidebar-mini">
              <a href="Logout.jsp" class="btn btn-primary btn-lg btn-block btn-icon-split">
                로그아웃
              </a>
            </div>
        </aside>
