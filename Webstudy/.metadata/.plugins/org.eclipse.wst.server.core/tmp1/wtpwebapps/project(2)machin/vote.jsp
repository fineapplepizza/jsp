         ...
         <form action="http://127.0.0.1:5000/dogmc" method="get">
            <div>
               <fieldset>
                  <table  class="vote">
                     <tr>
                        <td colspan="2"><h2>어떤 반려견을 희망하시나요 ?</h2></td>
                     </tr>
                     <tr>
                        <td>
                           <!-- 설문조사 내용 -->
                     ...
                     <tr>
                         <td>
                           4.반려견과 같이 얼마나 놀아줄수 있나요? (1.적다~5.많다)
                        </td>
                        <td class=input_td>
                     ...
                     <tr>
                        <td>
                           <!-- 설문조사 내용 -->
                           6. 반려견의 털빠짐에 민감하신가요? (1.아니다~5.그렇다)
                        </td>
                        <td class=input_td>
                           <input type="radio" value="5" name="v6" id="v6_1"><label for="v6_1">1</label>
                           <input type="radio" value="4" name="v6"  id="v6_2"><label for="v6_2">2</label>
                           <input type="radio" value="3" name="v6"  id="v6_3"><label for="v6_3">3</label>
                           <input type="radio" value="2" name="v6"  id="v6_4"><label for="v6_4">4</label>
                           <input type="radio" value="1" name="v6"  id="v6_5"><label for="v6_5">5</label>
                        </td>
                     </tr>
                     <tr>
                        <td>
                           <!-- 설문조사 내용 -->
                           7. 반려견이 사랑을 적극적으로 표현하였으면 좋겠나요?
                        </td>
                        <td class=input_td>
                        ...
                        <td>
                           <!-- 설문조사 내용 -->
                           8. 매 달 반려견의 의료비용은 얼마나 지출하실수 있나요?
                        </td>
                        <td class=input_td>
                           ...
                           <input type="radio" value="30o" name="v8"  id="v8_3"><label for="v8_3">월 30만원 이상</label>
                     ...
                     <tr>
                        <td>
                           <!-- 설문조사 내용 -->
                           9. 반려견과 함께할 가족구성원 중 7세 이하의 아이가 있나요?
                        </td>
                        <td class=input_td>
                     ...
                     <tr>
                        <td>
                           <!-- 설문조사 내용 -->
                           10. 반려견의 짖음이 심하면 곤란한가요? (1.상관없다~5.그렇다)
                        </td>
                        <td class=input_td>
                           <input type="radio" value="5" name="v10" id="v10_1"><label for="v10_1">1</label>
                           <input type="radio" value="4" name="v10"  id="v10_2"><label for="v10_2">2</label>
                           <input type="radio" value="3" name="v10"  id="v10_3"><label for="v10_3">3</label>
                           <input type="radio" value="2" name="v10"  id="v10_4"><label for="v10_4">4</label>
                           <input type="radio" value="1" name="v10"  id="v10_5"><label for="v10_5">5</label>
                        </td>
                     </tr>
                     <tr>
                        <td>
                           <!-- 설문조사 내용 -->
                           11. 반려견의 집지키기 능력은 어느정도 였으면 좋겠는가요?
                        </td>
                        <td class=input_td>
                     ...
                     <tr>
                              ...
                              <a href = "introduce.jsp"><input type="button" value="뒤로가기" class="button big"></a>
                                 <input type="submit" value="설문완료" class="button big">
