 	...
 	$.ajax({
 	      ...
 	      success : function(check){
 	            ...
 	            var mapContainer = document.getElementById('map'), // 지도를 표시할 div 
 	              mapOption = {
 	                  center: new kakao.maps.LatLng(35.1104991, 126.8755732), // 지도의 중심좌표
 	                  level: 5, // 지도의 확대 레벨
...
// 	                        console.log("검색 성공");
 	                     ...
 	                     //console.log(result[0].x);
 	                       ...
 	                       var infowindow = new kakao.maps.InfoWindow({
 	                           content: '센터명 :<div style="width:150px;text-align:left;padding:0px 0;">'+ C_Name +'</div>'+
...
// 	                       }//else끝
 	            ...
 	            input_click.addEventListener('click', function(){
 	               var i = ($('#addr_do').val() + " " + $('#addr_siGoon').val());
 	               console.log(i);
 	               
 	               geocoder.addressSearch(i, function(result1, status1) {
 	                  
 	                   // 정상적으로 검색이 완료됐으면 
 	                    if (status1 === kakao.maps.services.Status.OK) {

 	                       var coords = new kakao.maps.LatLng(result1[0].y, result1[0].x);
 	                     console.log(coords);
