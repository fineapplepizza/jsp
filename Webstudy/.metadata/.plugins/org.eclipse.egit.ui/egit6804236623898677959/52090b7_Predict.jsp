          ...
          <!-- Start 주식 종목 정보 -->
              ...
              <div class="section-body">
                ...
                <p class="section-lead">
                  주가예측 페이지 대한 설명 ~Organize and adjust all settings about this site.
                </p>
                  ...
                  <div class="col-lg-6" >
                    <div class="card card-large-icons">
                      ...
                      <div >
                        ...
                        <i class="fas fa-bookmark fa-2x" style="position: relative; left:270px; bottom: 25px;"></i>
              ...
              <div class="card-body">
                ...
                <table class="table table-hover">
                  <thead>
                    <tr>
                      <th scope="col">#</th>
                      <th scope="col">0809</th>
                      <th scope="col">0810</th>
                      <th scope="col">0811</th>
                      <th scope="col">0812</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <ul class="nav nav-tabs">
                    <li class="nav-item">
                      <a class="nav-link active" href="#">1년 전</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="#">3개월 전</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="#">3개월 후</a>
                    </li>
                    <!-- disabled는 반응안함 -->
                    <li class="nav-item">
                      <a class="nav-link disabled" href="#">1년 후 </a>
                    </li>
                  </ul>

                  <!-- 각각 iframe형태로 가져오게 만들어야할듯 -->
                  <div>
                    <table style="text-align:center; width:100%; margin:10px; margin-top: 20px;">
                      <tbody>
